declare module 'texzilla'
{
    export default class TeXZilla
    {
         ...
         */
        static setDOMParser(parser: DOMParser): void;
         ...
         */
        static setXMLSerializer(serializer: XMLSerializer): void;
         ...
         */
        static setItexIdentifierMode(enabled: boolean): void;
         ...
         */
        static getTeXSource(el: string | Element): string | null;
         ...
         */
        static toMathMLString(str: string, displayMode?: boolean, rightToLeft?: boolean, throwOnError?: boolean): string;
         ...
         * @param throwOnError - indicates whether TeXZilla should throw an exception when parsing fails
         */
        static toMathML(str: string, displayMode?: boolean, rightToLeft?: boolean, throwOnError?: boolean): Element;
         ...
         */
        static toImage(str: string, rightToLeft?: boolean, roundToPowerOfTwo?: boolean, size?: number, document?: Document): HTMLImageElement;
         ...
         * @param throwOnError - indicates whether TeXZilla should throw an exception when parsing fails
         */
        static filterString(str: string, throwOnError?: boolean): string;
         ...
         * @param throwOnError - indicates whether TeXZilla should throw an exception when parsing fails
         */
        static filterElement(el: Element, throwOnError?: boolean): void;
    }
}